...
#
# Vendored verbatim from dryvist/cc-edge-pack-template scripts/build-crbl.sh
# (required by the shared cribl-pack-release.yml reusable workflow, which
# checks out the calling repo and runs ./scripts/build-crbl.sh).
