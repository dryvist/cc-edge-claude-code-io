...
Pack configuration lives under `default/` and is edited directly:

1. **`package.json`** — `name`, `description`, `displayName`, `tags`. The pack
   name follows the convention `cc-edge-<source>-io` (Edge) or
